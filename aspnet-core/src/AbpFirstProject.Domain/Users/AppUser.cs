...
namespace AbpFirstProject.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpFirstProjectDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpFirstProjectEfCoreEntityExtensionMappings to extend the IdentityUser entity
